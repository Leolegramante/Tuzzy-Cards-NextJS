...
type CreateOrderErrorProps = {
    isOpen: boolean,
    onCloseAction: () => void
}

export function CreateOrderErrorModal({onCloseAction, isOpen}: CreateOrderErrorProps) {
    return (
        <div>
                ...
                <div className="fixed inset-0 z-10 w-screen overflow-y-auto">
                    <div className="flex min-h-full items-end justify-center p-4 text-center sm:items-center sm:p-0">
                        ...
                        >
                            <div>
                                <div
                                    className="mx-auto flex size-12 items-center justify-center rounded-full bg-red-100">
