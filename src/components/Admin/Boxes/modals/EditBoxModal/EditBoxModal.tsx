...
import {EditBoxState, handleBoxForm} from "./actions";
...
export const EditBoxModal = ({isOpen, onCloseAction, box}: EditBoxModalProps) => {
    const formRef = useRef<HTMLFormElement>(null);

    const initialState: EditBoxState = useMemo(() => ({
        isValid: undefined,
        errors: null,
        id: box.id ? box.id : 0,
        name: box.name,
    ...
    const [state, formAction, isPending] = useActionState<EditBoxState>(
        async (currentState: EditBoxState) => {
